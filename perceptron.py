...
# the first list x-vector indicates a customer's number in the queue of the waiting list say 1,2...the second list y-vector indicates amount in minutes the customer will have to wait for the corresponding queue number
